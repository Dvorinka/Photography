...
! function(e, t) {
  ...
  return function(e, t) {
    ...
    }(".medium-zoom-overlay{position:fixed;top:0;right:0;bottom:0;left:0;opacity:0;transition:opacity .3s;will-change:opacity}.medium-zoom--opened .medium-zoom-overlay{cursor:pointer;cursor:zoom-out;opacity:1}. {cursor:pointer;cursor:zoom-in;transition:transform .3s cubic-bezier(.2,0,.2,1)}. --hidden{visibility:hidden}. --opened{position:relative;cursor:pointer;cursor:zoom-out;}"),
    function t(e) {
          ...
          return new n(function(t) {
            if (p && -1 === v.indexOf(p)) t(L);
              ...
              if (document.body.appendChild(E.zoomed), window.requestAnimationFrame(function() {
                ...
                }), E.original.classList.add(" --hidden"), E.zoomed.classList.add(" --opened"), E.zoomed.addEventListener("click", h), E.zoomed.addEventListener("transitionend", function e() {
                ...
                var s = setInterval(function() {
                  E.zoomedHd.complete && (clearInterval(s), E.zoomedHd.classList.add(" --opened"), E.zoomedHd.addEventListener("click", h), document.body.appendChild(E.zoomedHd), g())
                }, 10)
                ...
                var f = E.zoomedHd.addEventListener("load", function() {
                  E.zoomedHd.removeEventListener("load", f), E.zoomedHd.classList.add(" --opened"), E.zoomedHd.addEventListener("click", h), document.body.appendChild(E.zoomedHd), g()
                })
              } else g()
            }
          })
        ...
        h = function() {
          return new n(function(t) {
            !z && E.original ? (z = !0, document.body.classList.remove("medium-zoom--opened"), E.zoomed.style.transform = "", E.zoomedHd && (E.zoomedHd.style.transform = ""), E.template && (E.template.style.transition = "opacity 150ms", E.template.style.opacity = 0), E.original.dispatchEvent(x("medium-zoom:close", {
              ...
              E.original.classList.remove(" --hidden"), document.body.removeChild(E.zoomed), E.zoomedHd && document.body.removeChild(E.zoomedHd), document.body.removeChild(w), E.zoomed.classList.remove(" --opened"), E.template && document.body.removeChild(E.template), z = !1, E.zoomed.removeEventListener("transitionend", e), E.original.dispatchEvent(x("medium-zoom:closed", {
                detail: {
                  zoom: L
                }
      ...
      var L = {
        ...
        detach: function() {
          ...
          return n.forEach(function(e) {
            e.classList.remove(" "), e.dispatchEvent(x("medium-zoom:detach", {
              detail: {
                zoom: L
              }
            }))
